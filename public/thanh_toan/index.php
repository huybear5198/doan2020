...
<style>
	...
	body {
		background:url('include/nguyendeptrai.jpg');
		margin-left: 300px;
		color:white;
		font-family: 'Merriweather', serif;
	}
...
if(@$_POST['nlpayment']) {
	...
	$array_items=array();				 
	 ...
	 $tax_amount=0;
	 $fee_shipping=0;
	 $return_url ='localhost:81/final/doan2020/public/thanh_toan/payment_success.php';
	 $cancel_url =urlencode('localhost:81/final/doan2020/public/thanh_toan?orderid='.$order_code) ;
	...
	if($payment_method !='' && $buyer_email !="" && $buyer_mobile !="" && $buyer_fullname !="" && filter_var( $buyer_email, FILTER_VALIDATE_EMAIL )  ){
		...
		echo "<script> 
  alert('Bạn chưa nhập đủ thông tin khách hàng')
</script>
";
	}
 }				
...
<div id="noidung" float="center">
	...
	<form  name="NLpayBank" action="#" method="post">	
		<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td>Số tiền bạn muốn tài trợ: </td>
				<td>
        				    
					 <input  class="w3-input w3-border w3-round-xxlarge"type="text" style="width:270px;" id="total_amount" name="total_amount"  value="">
					 <script>
					 var number=document.getElementById("total_amount");
					    console.log(new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'vnd' }).format(number));</script>
				</td>
			</tr>
			<tr><td>Họ Tên: </td>
				<td>
					 <input class="w3-input w3-border w3-round-xxlarge" type="text" style="width:270px" id="fullname" name="buyer_fullname" value="">
				</td>
			</tr>
			<tr><td>Email: </td>
				<td>
					 <input  class="w3-input w3-border w3-round-xxlarge"type="text" style="width:270px" id="fullname" name="buyer_email" value="">
				</td>
			</tr>
			<tr><td>Số Điện thoại: </td>
				<td>
					 <input class="w3-input w3-border w3-round-xxlarge" type="text" style="width:270px" id="fullname" name="buyer_mobile" value="">
				</td>
			</tr>				
		</table>	
	<ul class="list-content">
		<li class="active">
			...
			<div class="boxContent">
				...
				Nếu chưa có tài khoản ngân lương đăng ký ví NgânLượng.vn miễn phí <a href="https://www.nganluong.vn/?portal=nganluong&amp;page=user_register" target="_blank">tại đây</a></p>
			</div>
		</li>
		<li>
	...
	<table style="clear:both;width:500px;padding-left:46px;"> 
			...
			<tr><td></td>
				<td>
					 <input class="w3-btn w3-blue" type="submit" name="nlpayment" value="Thanh Toán"/>
				</td>
				<td>
					 <a href="http://localhost:81/final/doan2020/public/"><input class="w3-btn w3-blue" type="button" value="Quay lại"/></a>
				</td>
			</tr>	
