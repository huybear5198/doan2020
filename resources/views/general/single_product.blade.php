		        ...
		        <div class="card">
		            <div class="card-body">
		                <div class="row">
		                  ...
		                  <div class="col-md-6">
		                     <ul>
		                         <li><strong>Thành phố :</strong> 2017 </li>
		                         <li><strong>Quận :</strong> 39,239 km </li>
		                         <li><strong>Địa chỉ :</strong> Petrol </li>
		                         <li><strong>Đường :</strong> Manual </li>
		        ...
		        <div class="card bg-light ">
		            <div class="card-body">
		                ...
		                <div class="form-group">
                            <button style="width:310px;" type="button" class="btn btn-success">Liên hệ với người bán</button>
		               </div>
		                <div class="form-group">
                            <button style="width:310px;" type="button" class="btn btn-info">Lấy số điện thoại từ người bán</button>
		               </div>
